...
- [x] Species search API: fuzzy search by name/genus/family
- [x] Import scripts: plantnet300k, seed, hash index, orchestrator
...
- [ ] Vercel deployment
- [ ] GBIF Darwin Core Archive download (2.59M records)
- [ ] PlantNet-300K metadata download
- [ ] Build perceptual hash index from images
